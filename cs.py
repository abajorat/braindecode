def create_config_space():
	...
	input_time_length = CS.UniformIntegerHyperparameter("input_time_length",
                                                 lower=?,
                                                 default_value=1000,
                                                 upper=?,
                                                 log=False)
	final_conv_length = CS.UniformIntegerHyperparameter("final_conv_length",
                                                 lower=1,
                                                 default_value=??,
                                                 upper=14,
                                                 log=False)
	...
	drop_prob = CS.UniformFloatHyperparameter("drop_prob",
                                                  ...
                                                  upper=0.9,
                                                  log=False)
    # double_time_convs = CS.CategoricalHyperparameter("double_time_convs",['False', 'True'] )
	...
	batch_norm_alpha = CS.UniformFloatHyperparameter("batch_norm_alpha",
                                                  ...
                                                  upper=?,
                                                  log=False)
	cs.add_hyperparameter(final_conv_length)
	...
	# final_conv_length is auto in code but integer also(2)
	# double_time_convs is not used
